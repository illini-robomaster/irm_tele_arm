...
class UARTCommunicator(Communicator):
    ...
    def _listen(self, hz=200) -> None:
        ...
        This function updates circular_buffer and state_dict.dict.
    ...
    def update_current_state(self, ret_dict) -> None:
        ...
        Helper function.
        """
        # Dont do self.state_dict.dict = ret_dict['data'] because different
        # threads may need different information from the stm32
        self.state_dict.specific_update(ret_dict['data'])
    ...
    def get_current_state_dict(self) -> dict:
        ...
        return self.state_dict.deepcopy()
